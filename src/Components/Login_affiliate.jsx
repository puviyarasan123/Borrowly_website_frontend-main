...
const AffiliateLogin = () => {
  ...
  const [stage, setStage] = useState(1); // 1=login, 2=forgot, 3=otp, 4=reset
    ...
    >
      ...
      <div className="w-full flex-1 py-10 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[#7B7575] md:w-[80%] mx-auto text-[14px] mt-1">
        ...
        {stage === 1 && (
          <form
            onSubmit={handleSubmit((data) => console.log("Login data", data))}
        ...
        {stage === 3 && (
          <div className="w-full max-w-[450px]">
            ...
            <div className="text-center mt-3 text-sm text-[#6E6D6D]">
              Didn’t get the code?
              <button
                onClick={() => setResendTimer(RESEND_SECONDS)}
    ...
    <button
      onClick={() => {
        if (newPassword === confirmPassword && newPassword.length >= 6) {
          // Here you can call API to reset password
          alert("Password reset successfully!");
          setStage(1); // Redirect back to login
