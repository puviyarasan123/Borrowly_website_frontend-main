...
      // Round to the nearest step to prevent floating point issues
      newValue = Math.round(newValue / step) * step;

      // New: Force rounding to one decimal place for display and state update
      // This is the key fix for the interest rate
      if (unit === '%') {
...
              </div>
            </div>
            <Slider min={selectedLoan.minRate} max={selectedLoan.maxRate} value={interestRate} setValue={setInterestRate} step={0.1} unit="%" />
            <div style={{ fontFamily: 'PovetaracSansBold' }} className="flex justify-between text-[#838383] text-[14px] md:text-[18px]">
