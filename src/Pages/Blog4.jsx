...
import blogBanner from '../assets/Images/Blog5.avif'; // Assuming a banner image for the blog page
...
const CreditScoreBoost = () => {
  const actions = [
    { text: "Pay All Bills On Time", details: "Late payments can harm your credit score." },
    { text: "Reduce Outstanding Debt", details: "Focus on paying off high-interest loans first." },
    { text: "Avoid Multiple Loan Applications", details: "Too many inquiries in a short period can lower your score." },
    { text: "Keep Credit Utilization Low", details: "Aim to use less than 30% of your available credit." },
    { text: "Maintain a Healthy Credit Mix", details: "A combination of secured and unsecured loans is beneficial." },
    { text: "Set Up Auto-Payments", details: "This ensures timely repayments and prevents missed due dates." },
    { text: "Dispute Errors in Credit Report", details: "Correct any mistakes on your report promptly to ensure accuracy." },
    { text: "Increase Credit Limits Wisely", details: "A higher limit can help reduce your credit utilization percentage." },
    { text: "Avoid Closing Old Accounts", details: "A longer credit history strengthens your score." },
    { text: "Monitor Score Monthly", details: "Stay on top of changes and improvements to your score." },
  ];
      ...
      >
        <motion.div variants={fadeUp}>
          ...
          <h1
            ...
            variants={fadeUp}
          >
            10 Easy Ways to Boost Your Credit Score in 90 Days
          </h1>
          <p
            ...
            variants={fadeUp}
          >
            Improving your CIBIL score requires consistency and discipline. Following these steps can significantly boost your score within three months.
          </p>
        </motion.div>
...
export default CreditScoreBoost;